...
class CourseDirection(BaseModel):
    ...
    remark=models.TextField(default='',blank=True,null=True,verbose_name='方向描述')#blank控制表单验证的行为，表示该字段在Django的表单（如ModelForm）中是可选 null控制数据库存储的行为，表示该字段在数据库中可以存储NULL值
